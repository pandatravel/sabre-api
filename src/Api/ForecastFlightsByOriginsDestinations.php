 ...
 */
class ForecastFlightsByOriginsDestinations extends AbstractRequest
{
    /**
     * Endpoint
     *
     * @var string
     */
    protected $uri = '/lists/supported/forecast/flights/origins-destinations';
     ...
     * @throws \Ammonkc\SabreApi\Exception\ForecastFlightsByOriginsDestinationsBadRequestException
    ...
    public function sendData($data)
    {
        try {
            ...
            if ($e->getCode() === 400) {
                throw new ForecastFlightsByOriginsDestinationsBadRequestException($e);
            }
            if ($e->getCode() === 404) {
                throw new ForecastFlightsByOriginsDestinationsNotFoundException($e);
            }
            if ($e->getCode() === 413) {
                throw new ForecastFlightsByOriginsDestinationsRequestEntityTooLargeException($e);
            }
            throw $e;
        }
