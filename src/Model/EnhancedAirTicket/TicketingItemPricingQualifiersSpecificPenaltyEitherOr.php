...
class TicketingItemPricingQualifiersSpecificPenaltyEitherOr extends AbstractModel
{
    /**
     * "Any" is used to specify any refundable OR changeable fare options.
     *
     * @var bool
     */
    protected $any;
    /**
     * "CurrencyCode" is used to specify the specific currency for either maximum refund OR change penalty.
     *
     * @var string
     */
    protected $currencyCode;
    /**
     * "MaxPenalty" is used to specify maximum refund OR change penalty. If a value of "0" is input no penalty is preferred. If a value of "N" is input only non-changeable options are requested.
