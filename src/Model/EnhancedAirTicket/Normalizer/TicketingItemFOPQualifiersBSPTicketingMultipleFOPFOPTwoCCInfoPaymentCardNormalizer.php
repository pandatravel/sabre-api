...
class TicketingItemFOPQualifiersBSPTicketingMultipleFOPFOPTwoCCInfoPaymentCardNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Ammonkc\\SabreApi\\Model\\EnhancedAirTicket\\TicketingItemFOPQualifiersBSPTicketingMultipleFOPFOPTwoCCInfoPaymentCard';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Ammonkc\SabreApi\Model\EnhancedAirTicket\TicketingItemFOPQualifiersBSPTicketingMultipleFOPFOPTwoCCInfoPaymentCard;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Ammonkc\SabreApi\Model\EnhancedAirTicket\TicketingItemFOPQualifiersBSPTicketingMultipleFOPFOPTwoCCInfoPaymentCard();
        ...
        if (property_exists($data, 'ManualOBFee')) {
            $object->setManualOBFee($data->{'ManualOBFee'});
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getManualOBFee()) {
            $data->{'ManualOBFee'} = $object->getManualOBFee();
        }
