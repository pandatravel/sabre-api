...
class OrgOpentravelOta200305ExchangeSourceTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \Ammonkc\SabreApi\Model\BargainFinderMax\OrgOpentravelOta200305ExchangeSourceType;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'CoHostID')) {
        ...
        if (property_exists($data, 'ETicketCapable')) {
        ...
        if (property_exists($data, 'HostCarrier')) {
