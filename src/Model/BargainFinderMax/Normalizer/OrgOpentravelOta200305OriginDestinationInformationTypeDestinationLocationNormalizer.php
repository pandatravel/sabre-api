...
class OrgOpentravelOta200305OriginDestinationInformationTypeDestinationLocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305OriginDestinationInformationTypeDestinationLocation';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Ammonkc\SabreApi\Model\BargainFinderMax\OrgOpentravelOta200305OriginDestinationInformationTypeDestinationLocation;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Ammonkc\SabreApi\Model\BargainFinderMax\OrgOpentravelOta200305OriginDestinationInformationTypeDestinationLocation();
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getAllAirports()) {
            $data->{'AllAirports'} = $object->getAllAirports();
        }
