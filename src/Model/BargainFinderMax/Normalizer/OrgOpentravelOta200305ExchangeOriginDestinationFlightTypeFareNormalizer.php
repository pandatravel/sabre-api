...
class OrgOpentravelOta200305ExchangeOriginDestinationFlightTypeFareNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305ExchangeOriginDestinationFlightTypeFare';
    }

    public function supportsNormalization($data, $format = null)
    {
        return get_class($data) === 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305ExchangeOriginDestinationFlightTypeFare';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Ammonkc\SabreApi\Model\BargainFinderMax\OrgOpentravelOta200305ExchangeOriginDestinationFlightTypeFare();
        if (property_exists($data, 'Adjustment') && $data->{'Adjustment'} !== null) {
            $object->setAdjustment($this->denormalizer->denormalize($data->{'Adjustment'}, 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305ExchangeOriginDestinationFlightTypeFareAdjustment', 'json', $context));
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getAdjustment()) {
            $data->{'Adjustment'} = $this->normalizer->normalize($object->getAdjustment(), 'json', $context);
        }
