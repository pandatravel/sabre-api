...
class OrgOpentravelOta200305PassengerPriceAdjustmentTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305PassengerPriceAdjustmentType';
    }

    public function supportsNormalization($data, $format = null)
    {
        return get_class($data) === 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305PassengerPriceAdjustmentType';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Ammonkc\SabreApi\Model\BargainFinderMax\OrgOpentravelOta200305PassengerPriceAdjustmentType();
        ...
        if (property_exists($data, 'PassengerID') && $data->{'PassengerID'} !== null) {
            $object->setPassengerID($data->{'PassengerID'});
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getPassengerID()) {
            $data->{'PassengerID'} = $object->getPassengerID();
        }
