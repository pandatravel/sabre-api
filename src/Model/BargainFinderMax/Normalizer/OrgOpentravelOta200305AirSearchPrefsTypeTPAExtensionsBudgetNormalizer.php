...
class OrgOpentravelOta200305AirSearchPrefsTypeTPAExtensionsBudgetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305AirSearchPrefsTypeTPAExtensionsBudget';
    }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getMinimumPrice()) {
            $data->{'MinimumPrice'} = $object->getMinimumPrice();
        }
        if (null !== $object->getRelativePriceThreshold()) {
            $data->{'RelativePriceThreshold'} = $object->getRelativePriceThreshold();
        }
