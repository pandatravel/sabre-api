...
class OrgOpentravelOta200305StopoverTypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Ammonkc\\SabreApi\\Model\\BargainFinderMax\\OrgOpentravelOta200305StopoverType';
    }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getStopoverPoint()) {
            $data->{'StopoverPoint'} = $this->normalizer->normalize($object->getStopoverPoint(), 'json', $context);
        }
