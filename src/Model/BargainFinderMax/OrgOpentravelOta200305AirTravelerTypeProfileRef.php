...
class OrgOpentravelOta200305AirTravelerTypeProfileRef extends AbstractModel
{
     ...
     * (e.g. an airline reservation reference, customer profile
     * reference, booking confirmation number, or a reference
     * to a previous availability quote).
     *
     ...
     * to a previous availability quote).
     *
     * @param OrgOpentravelOta200305UniqueIDType|null $uniqueID
     *
     * @return self
     */
