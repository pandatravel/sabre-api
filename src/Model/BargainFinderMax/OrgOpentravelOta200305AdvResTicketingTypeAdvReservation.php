...
{
    /**
     * The amount of elapsed time or number of occurrences of a day
     * of the week before departure needed to satisfy an advance reservation requirement.
     *
     * @var string
     */
    protected $latestPeriod;
    /**
     * The time of day by which reservations must be made on the last
     * day that advance reservations can be made.
     *
     * @var string
     */
    ...
    /**
     * The amount of elapsed time or number of occurrences of a day of the
     * week before departure needed to satisfy an advance reservation requirement.
     *
     * @return string|null
     */
     ...
     * week before departure needed to satisfy an advance reservation requirement.
     *
     * @param string|null $latestPeriod
     *
     * @return self
     */
    ...
    /**
     * The time of day by which reservations must be made on the last day
     * that advance reservations can be made.
     *
     * @return string|null
     */
     ...
     * that advance reservations can be made.
     *
     * @param string|null $latestTimeOfDay
     *
     * @return self
     */
