...
class OrgOpentravelOta200305AirSearchPrefsTypeTPAExtensionsDiversityParameters extends AbstractModel
{
    ...
    /**
     * Defines how the options in the response should be distributed between
     * certain departure time of day ranges. All defined TimeOfDayRanges
     * need to cover the whole day and the sum of all Percentages needs to equal 100.
     *
     ...
     * Defines how many additional non-stop options should be added to the response. Overrides @Percentage.
     *
     * @param int|null $additionalNonStopsNumber
     *
     * @return self
     */
     ...
     * Defines how many additional non-stop options should be added to the response as a percentage of the requested number of options.
     *
     * @param int|null $additionalNonStopsPercentage
     *
     * @return self
     */
     ...
     * Defines the requested ratio of inbounds to outbounds in the response.
     *
     * @param int|null $inboundOutboundPairing
     *
     * @return self
     */
     ...
     * between certain departure time of day ranges. All defined
     * TimeOfDayRanges need to cover the whole day and the sum of
     * all Percentages needs to equal 100.
     *
     * @return OrgOpentravelOta200305AirSearchPrefsTypeTPAExtensionsDiversityParametersTimeOfDayDistribution|null
     */
     ...
     * all Percentages needs to equal 100.
     *
     * @param OrgOpentravelOta200305AirSearchPrefsTypeTPAExtensionsDiversityParametersTimeOfDayDistribution|null $timeOfDayDistribution
     *
     * @return self
     */
     ...
     *
     * @return OrgOpentravelOta200305AirSearchPrefsTypeTPAExtensionsDiversityParametersWeightings|null
     */
     ...
     * response. Sum of all weightings needs to equal 10.
     *
     * @param OrgOpentravelOta200305AirSearchPrefsTypeTPAExtensionsDiversityParametersWeightings|null $weightings
     *
     * @return self
     */
