...
{
    /**
     * Turns on additional text output in response, see Description1 (D01)
     * and Description2 (D02) in response.,Free baggage piece is required on the whole journey.
     *
     * @var bool
     */
     ...
     * Number of baggage pieces requested,Determines type of baggage processing result.
     *
     * @param int|null $requestedPieces
     *
     * @return self
     */
