...
class OrgOpentravelOta200305TravelerInfoSummaryType extends AbstractModel
{
    ...
    /**
     * @return OrgOpentravelOta200305TravelerInformationType[]|null
     */
    ...
    /**
     * @param OrgOpentravelOta200305TravelerInformationType[]|null $airTravelerAvail
     *
     * @return self
     */
     ...
     * Identify pricing source, if negotiated fares are requested and if it is a reprice request.
     *
     * @return OrgOpentravelOta200305PriceRequestInformationType|null
     */
     ...
     * Identify pricing source, if negotiated fares are requested and if it is a reprice request.
     *
     * @param OrgOpentravelOta200305PriceRequestInformationType|null $priceRequestInformation
     *
     * @return self
     */
     ...
     * If true, this request is for a specific PTC and only fares applicable to that PTC will be checked and returned. It is the same as XOFares flag in Intellisell request.
     *
     * @param bool|null $specificPTCIndicator
     *
     * @return self
     */
     ...
     * Additional elements and attributes to be included if required, per Trading Partner Agreement (TPA).
     *
     * @return OrgOpentravelOta200305TravelerInfoSummaryTPAExtensionsType|null
     */
     ...
     * Additional elements and attributes to be included if required, per Trading Partner Agreement (TPA).
     *
     * @param OrgOpentravelOta200305TravelerInfoSummaryTPAExtensionsType|null $tPAExtensions
     *
     * @return self
     */
