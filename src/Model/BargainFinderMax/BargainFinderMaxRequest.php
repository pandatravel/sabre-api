...
class BargainFinderMaxRequest extends AbstractModel
{
     ...
     * include: - Time / Time Window - Connecting cities. -
     * Client Preferences (airlines, cabin, flight types etc.)
     * The Low Fare Search request contains similar information
     * to a Low Fare Search entry on an airline CRS or GDS.
     *
     ...
     * to a Low Fare Search entry on an airline CRS or GDS.
     *
     * @return BargainFinderMaxRequestOTAAirLowFareSearchRQ|null
     */
     ...
     * to a Low Fare Search entry on an airline CRS or GDS.
     *
     * @param BargainFinderMaxRequestOTAAirLowFareSearchRQ|null $oTAAirLowFareSearchRQ
     *
     * @return self
     */
