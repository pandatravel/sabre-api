...
class OrgOpentravelOta200305OTAAirLowFareSearchRQOriginDestinationInformation extends AbstractModel
{
     ...
     * Additional elements and attributes to be included if required, per Trading Partner Agreement (TPA).
     *
     * @return OrgOpentravelOta200305OTAAirLowFareSearchRQOriginDestinationInformationTPAExtensions|null
     */
     ...
     * Additional elements and attributes to be included if required, per Trading Partner Agreement (TPA).
     *
     * @param OrgOpentravelOta200305OTAAirLowFareSearchRQOriginDestinationInformationTPAExtensions|null $tPAExtensions
     *
     * @return self
     */
