...
class BargainFinderMaxRequestOTAAirLowFareSearchRQ extends AbstractModel
{
     ...
     * Include only flights with available booking codes (when True or when attribute not present).
     *
     * @param bool|null $availableFlightsOnly
     *
     * @return self
     */
     ...
     * Request direct flights between given locations. This defaults to false.
     *
     * @param bool|null $directFlightsOnly
     *
     * @return self
     */
     ...
     * A positive integer value that indicates the maximum number of responses desired in the return.
     *
     * @param string|null $maxResponses
     *
     * @return self
     */
    ...
    /**
     * @return OrgOpentravelOta200305OTAAirLowFareSearchRQOriginDestinationInformation[]|null
     */
    ...
    /**
     * @param OrgOpentravelOta200305OTAAirLowFareSearchRQOriginDestinationInformation[]|null $originDestinationInformation
     *
     * @return self
     */
     ...
     * Point of sale object.
     *
     * @return OrgOpentravelOta200305POSType|null
     */
     ...
     * Point of sale object.
     *
     * @param OrgOpentravelOta200305POSType|null $pOS
     *
     * @return self
     */
    ...
    /**
     * @param string|null $responseVersion
     *
     * @return self
     */
     ...
     * Whether all messages should be printed in separate MTP element or not. Works only with PSS response serializers.
     *
     * @param bool|null $separateMessages
     *
     * @return self
     */
     ...
     * Used to identify the sequence number of the transaction as assigned by the sending system; allows for an application to process messages in a certain order or to request a resynchronization of messages in the event that a system has been off-line and needs to retrieve messages that were missed.
     *
     * @param string|null $sequenceNmbr
     *
     * @return self
     */
     ...
     * Additional elements and attributes to be included if required, per Trading Partner Agreement (TPA).
     *
     * @return OrgOpentravelOta200305OTAAirLowFareSearchRQTPAExtensions|null
     */
     ...
     * Additional elements and attributes to be included if required, per Trading Partner Agreement (TPA).
     *
     * @param OrgOpentravelOta200305OTAAirLowFareSearchRQTPAExtensions|null $tPAExtensions
     *
     * @return self
     */
     ...
     * Air Low Fare Search Request preference information.
     *
     * @return OrgOpentravelOta200305AirSearchPrefsType|null
     */
     ...
     * Air Low Fare Search Request preference information.
     *
     * @param OrgOpentravelOta200305AirSearchPrefsType|null $travelPreferences
     *
     * @return self
     */
     ...
     * Whether each MTP content should be truncated to specified length or not. Works only with PSS response serializers.
     *
     * @param bool|null $truncateMessages
     *
     * @return self
     */
