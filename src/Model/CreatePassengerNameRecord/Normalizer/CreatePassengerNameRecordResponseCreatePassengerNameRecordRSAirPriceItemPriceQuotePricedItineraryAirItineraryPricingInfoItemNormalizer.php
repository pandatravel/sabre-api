...
class CreatePassengerNameRecordResponseCreatePassengerNameRecordRSAirPriceItemPriceQuotePricedItineraryAirItineraryPricingInfoItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \Ammonkc\SabreApi\Model\CreatePassengerNameRecord\CreatePassengerNameRecordResponseCreatePassengerNameRecordRSAirPriceItemPriceQuotePricedItineraryAirItineraryPricingInfoItem;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'AgencyCommission')) {
            $values = [];
        ...
        if (property_exists($data, 'BaggageProvisions')) {
            $values_2 = [];
        ...
        if (property_exists($data, 'FareCalculationBreakdown')) {
            $values_3 = [];
        ...
        if (property_exists($data, 'TicketingFees')) {
            $values_7 = [];
        ...
        if (property_exists($data, 'SolutionSequenceNmbr')) {
